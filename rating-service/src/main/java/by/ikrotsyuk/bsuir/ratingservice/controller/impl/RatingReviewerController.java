...
public class RatingReviewerController implements RatingReviewerOperations {
    ...
    @Override
    public ResponseEntity<Page<RatingResponseDTO>> viewLeavedReviews(Long reviewerId, ReviewerTypesRating reviewerType, int offset, int itemCount, String field, Boolean isSortDirectionAsc) {
