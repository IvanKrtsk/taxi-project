...
public interface RatingReviewerService {
    ...
    Page<RatingResponseDTO> viewLeavedReviews(Long reviewerId, ReviewerTypeTypes reviewerType, int offset, int itemCount, String field, Boolean isSortDirectionAsc);
