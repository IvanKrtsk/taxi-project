package by.ikrotsyuk.bsuir.passengerservice.e2e.steps;

import by.ikrotsyuk.bsuir.passengerservice.e2e.steps.config.CucumberTestConfig;
...
import static by.ikrotsyuk.bsuir.passengerservice.utils.TestDataGenerator.baseUri;
...
public class PassengerSteps {
    ...
    private String passengerCreatePayload;
    private String passengerUpdatePayload;
    private String id;
