package by.ikrotsyuk.bsuir.passengerservice.kafka;

public class KafkaConstants {
    public static final String BOOTSTRAP_SERVERS = "localhost:9092, localhost:9094";
    public static final String CONSUMER_GROUP_ID = "passenger-rating-updated";
    public static final String TRUSTED_PACKAGES = "*";
    public static final String TOPIC_NAME = "passenger-rating-updated-event-topic";
